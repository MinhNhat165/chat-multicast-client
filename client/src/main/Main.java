...
public class Main extends JFrame {
    ...
    public Main(int opt){
        status = opt;
//        name = JOptionPane.showInputDialog("Please enter your fucking name");
//        if(name == null ){
//            System.exit(1);
//        }
        while(name.isEmpty()){
    ...
    private void initComponents() {
        ...
        cmdMinimize.setIcon(new javax.swing.ImageIcon(Objects.requireNonNull(getClass().getResource("/icon/minimize.png")))); // NOI18N
